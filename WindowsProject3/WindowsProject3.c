...
HWND sort_hEdit,quest1_hEdit, quest2_hEdit, quest3_hEdit, quest4_hEdit, quest5_hEdit, quest_value1_hEdit, quest_value2_hEdit, quest_value3_hEdit, quest_value4_hEdit, quest_value5_hEdit;    //Handle to a Window의 약자
HWND sort, start, quest,mst,topological,dijkstra;
...
LRESULT CALLBACK Main(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam) {
    ...
    case WM_CREATE:
        ...
        CreateWindow(_T("BUTTON"), _T("다익스트라"), WS_CHILD | WS_VISIBLE, 165, 160, 150, 40, hwnd, (HMENU)5, NULL, NULL);
        CreateWindow(_T("BUTTON"), _T("-"), WS_CHILD | WS_VISIBLE, 320, 160, 150, 40, hwnd, (HMENU)6, NULL, NULL);
        break;
    case WM_COMMAND:
        if (LOWORD(wParam) == 1) {
...
LRESULT CALLBACK Quest(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam) {
    switch (msg) {
    case WM_CREATE:
        CreateWindow(_T("STATIC"), _T("      노드번호\t       값\t\t 연결되어 있는 노드번호"), WS_CHILD | WS_VISIBLE, 10, 10, 460, 20, hwnd, NULL, NULL, NULL);
        CreateWindow(_T("STATIC"), _T("             1"), WS_CHILD | WS_VISIBLE, 10, 40, 115, 20, hwnd, NULL, NULL, NULL);
        CreateWindow(_T("STATIC"), _T("             2"), WS_CHILD | WS_VISIBLE, 10, 60, 115, 20, hwnd, NULL, NULL, NULL);
        CreateWindow(_T("STATIC"), _T("             3"), WS_CHILD | WS_VISIBLE, 10, 80, 115, 20, hwnd, NULL, NULL, NULL);
        CreateWindow(_T("STATIC"), _T("             4"), WS_CHILD | WS_VISIBLE, 10, 100, 115, 20, hwnd, NULL, NULL, NULL);
        CreateWindow(_T("STATIC"), _T("             5"), WS_CHILD | WS_VISIBLE, 10, 120, 115, 20, hwnd, NULL, NULL, NULL);
        quest_value1_hEdit = CreateWindow(_T("EDIT"), _T(""), WS_CHILD | WS_VISIBLE | WS_BORDER, 125, 40, 110, 20, hwnd, NULL, NULL, NULL);
        quest_value2_hEdit = CreateWindow(_T("EDIT"), _T(""), WS_CHILD | WS_VISIBLE | WS_BORDER, 125, 60, 110, 20, hwnd, NULL, NULL, NULL);
        quest_value3_hEdit = CreateWindow(_T("EDIT"), _T(""), WS_CHILD | WS_VISIBLE | WS_BORDER, 125, 80, 110, 20, hwnd, NULL, NULL, NULL);
        quest_value4_hEdit = CreateWindow(_T("EDIT"), _T(""), WS_CHILD | WS_VISIBLE | WS_BORDER, 125, 100, 110, 20, hwnd, NULL, NULL, NULL);
        quest_value5_hEdit = CreateWindow(_T("EDIT"), _T(""), WS_CHILD | WS_VISIBLE | WS_BORDER, 125, 120, 110, 20, hwnd, NULL, NULL, NULL);
        quest1_hEdit = CreateWindow(_T("EDIT"), _T(""), WS_CHILD | WS_VISIBLE | WS_BORDER, 235, 40, 235, 20, hwnd, NULL, NULL, NULL);
        quest2_hEdit = CreateWindow(_T("EDIT"), _T(""), WS_CHILD | WS_VISIBLE | WS_BORDER, 235, 60, 235, 20, hwnd, NULL, NULL, NULL);
        quest3_hEdit = CreateWindow(_T("EDIT"), _T(""), WS_CHILD | WS_VISIBLE | WS_BORDER, 235, 80, 235, 20, hwnd, NULL, NULL, NULL);
        quest4_hEdit = CreateWindow(_T("EDIT"), _T(""), WS_CHILD | WS_VISIBLE | WS_BORDER, 235, 100, 235, 20, hwnd, NULL, NULL, NULL);
        quest5_hEdit = CreateWindow(_T("EDIT"), _T(""), WS_CHILD | WS_VISIBLE | WS_BORDER, 235, 120, 235, 20, hwnd, NULL, NULL, NULL);
        CreateWindow(_T("STATIC"), _T("노드의 갯수는 최대 5개(노드번호가 1인 노드가 시작점)"), WS_CHILD | WS_VISIBLE, 10, 150, 460, 20, hwnd, NULL, NULL, NULL);
        CreateWindow(_T("STATIC"), _T("노드번호는 띄어쓰기를 통해 입력(본인노드를 제외한 1~5)"), WS_CHILD | WS_VISIBLE, 10, 170, 460, 20, hwnd, NULL, NULL, NULL);
        CreateWindow(_T("STATIC"), _T("최대입력값은 2147483647, 문자입력시 0으로 취급"), WS_CHILD | WS_VISIBLE, 10, 190, 460, 20, hwnd, NULL, NULL, NULL);
    ...
    case WM_COMMAND:
        ...
        if (LOWORD(wParam) == 2) {        //너비 우선 탐색
            TCHAR buffer[256];
            GetWindowText(quest_value1_hEdit, buffer, 256);//hEdit에 적은 텍스트를 buffer로 전부 복사
            int numbers[256];
            int count = 0;
            TCHAR* token = _tcstok(buffer, _T(" "));
            while (token != NULL && count < 256) {
...
LRESULT CALLBACK Mst(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam) {
    ...
    case WM_CREATE:
        ...
        CreateWindow(_T("STATIC"), _T("\t\t진행중"), WS_CHILD | WS_VISIBLE, 20, 30, 440, 20, hwnd, NULL, NULL, NULL);
        CreateWindow(_T("BUTTON"), _T("뒤로가기"), WS_CHILD | WS_VISIBLE, 40, 220, 100, 30, hwnd, (HMENU)1, NULL, NULL);
        break;
    case WM_COMMAND:
        if (LOWORD(wParam) == 1) {
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow) {
    ...
    RegisterClassEx(&d);
    dijkstra = CreateWindow(d.lpszClassName, _T("다익스트라 알고리즘"), WS_OVERLAPPED | WS_CAPTION | WS_SYSMENU | WS_MINIMIZEBOX, x, y, 500, 300, NULL, NULL, d.hInstance, NULL);
    ShowWindow(dijkstra, SW_HIDE);
